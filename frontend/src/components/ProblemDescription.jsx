  ...
  return (
    <div className="h-full overflow-y-auto bg-base-100">
      ...
      <div className="p-6 space-y-6">
              ...
              <div key={idx}>
                ...
                <div className="bg-base-200 rounded-lg p-4 font-mono text-sm space-y-1.5">
                  <div className="flex gap-2">
                    <span className=" font-bold min-w-[70px]">Input:</span>
                    <span>{example.input}</span>
                  </div>
                  <div className="flex gap-2">
                    <span className=" font-bold min-w-[70px]">Output:</span>
        ...
        {/* constraints */}
        <div className="bg-base-100 rounded-xl shadow-sm p-5 border border-base-300">
          <h2 className="text-xl font-bold text-base-content">Constraints</h2>
